...
Welcome to my academic portfolio! I am a Ph.D. student in the Department of Electrical and Computer Engineering at the University of Wisconsin-Madison, working in the Nanoscale Quantum Materials and Devices Lab. 
...
* Conducted precision cryogenic measurements on $NbSe_2$ nano-oscillators to analyze Duffing nonlinearity and extract nanomechanical parameters during superconducting phase transitions.
* Designed and manufactured a custom mechanical strain cell for *in-situ* uniaxial stretching, enabling the measurement of Raman peak splitting in 2D magnetic semiconductor $CrSBr$.
* Investigated quantum emission in thin-layer topological $TaIrTe_4$, characterizing photoluminescence and polarization dependence to identify Single Photon Emitters (SPEs).

**Short-term Academic Scholar | Rice University** *(08/2024 – 12/2024)*
